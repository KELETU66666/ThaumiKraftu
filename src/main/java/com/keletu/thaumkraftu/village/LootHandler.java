...
public final class LootHandler {
	...
	public LootHandler() {
		for (String s : TABLES) {
			LootTableList.register(new ResourceLocation(ThaumKraftu.MOD_ID, s));
		}
	}
	...
	private LootEntryTable getInjectEntry(String name, int weight) {
		return new LootEntryTable(new ResourceLocation(ThaumKraftu.MOD_ID, "inject/" + name), weight, 0, new LootCondition[0], "tk_inject_entry");
	}
