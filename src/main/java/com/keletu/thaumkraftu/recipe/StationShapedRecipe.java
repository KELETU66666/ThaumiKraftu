 ...
 */
public class StationShapedRecipe extends StationRecipeBase {
    ...
    public StationShapedRecipe(@Nonnull ItemStack result, ShapedPrimer primer) {
        output = result.copy();
        width = primer.width;
    ...
    public StationShapedRecipe(@Nonnull ItemStack result, Object... recipe) {
    ...
    public static StationShapedRecipe fromJson(JsonContext context, JsonObject json) {
        ...
        return new StationShapedRecipe(result, primer);
    }
}
